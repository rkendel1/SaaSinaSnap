...
import { EmbedManagerClient } from '@/features/creator/components/EmbedManagerClient';
...
export default async function PlatformEmbedsAndScriptsPage() {
  ...
  return <EmbedManagerClient initialEmbeds={embedAssets} creatorProfile={platformOwnerProfile} products={transformedProducts} />;
}
