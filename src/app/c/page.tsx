        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Discover amazing creators and their offerings</p>
            </div>
            <Link href="/">
