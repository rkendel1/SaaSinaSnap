    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {products.map((product, index) => (
          <div key={index} className="border border-zinc-700 rounded-lg p-4 space-y-4 bg-zinc-800">
            <div className="flex justify-between items-center">
              <h3 className="font-medium text-gray-200">Product {index + 1}</h3>
              {products.length > 1 && (
                <Button
                  variant="ghost"
                  size="sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex">
                  <select
                    ...
                    className="flex h-9 w-16 rounded-l-md border border-zinc-700 bg-zinc-900 px-2 py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 text-gray-200"
                  >
                  ...
                  <Input
                    ...
                    className="rounded-l-none border-zinc-700 bg-zinc-900 text-gray-200 placeholder:text-gray-400"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <textarea
                  ...
                  className="flex min-h-[80px] w-full rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm ring-offset-background placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="flex h-9 w-full rounded-md border border-zinc-700 bg-zinc-900 px-3 py-1 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 text-gray-200"
                >
      ...
      <div className="border-2 border-dashed border-zinc-700 rounded-lg p-8 bg-zinc-800">
        <div className="text-center">
          <Upload className="h-8 w-8 mx-auto mb-4 text-gray-400" />
          <h3 className="font-medium mb-2 text-gray-200">Import from Existing Store</h3>
          <p className="text-sm text-gray-400 mb-4">
            Already have products in Shopify, WooCommerce, or another platform? Import them automatically.
          </p>
          <Button variant="outline" disabled className="border-zinc-700 text-gray-200 hover:bg-zinc-800">
