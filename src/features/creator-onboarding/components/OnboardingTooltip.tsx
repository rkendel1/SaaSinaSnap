    ...
    <div className="relative inline-block">
      ...
      {isVisible && (
        <>
          ...
          {/* Tooltip */}
          <div className={cn(
            "absolute z-50 w-80 max-w-sm p-4 bg-gray-900 text-white rounded-lg shadow-xl border border-gray-700",
    ...
    <OnboardingTooltip
      ...
      content={
        <div className="space-y-2">
          ...
          <div className="bg-green-900/20 border border-green-500/20 p-2 rounded mt-2">
