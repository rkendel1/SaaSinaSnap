...
export function WelcomeStep({ onNext }: WelcomeStepProps) {
  return (
    <div className="space-y-6 text-center">
      ...
      <h2 className="text-2xl font-bold text-gray-50">Welcome, Platform Owner!</h2>
      ...
      <div className="bg-blue-900/30 border border-blue-700 rounded-lg p-6 text-left space-y-4">
        <h3 className="font-semibold text-blue-200">What you'll set up:</h3>
        <ul className="list-disc list-inside text-sm text-blue-300 space-y-2">
